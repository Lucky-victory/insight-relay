      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 mb-12">
            ...
            <div className="px-3 py-1 rounded-full bg-[#2EC8C3]/20 text-[#2EC8C3] text-sm font-medium">
              Save 17%
            </div>
          </div>
        </motion.div>
            ...
            >
              {plan.popular && (
                <div className="absolute z-10 -top-4 left-1/2 transform -translate-x-1/2">
                  <div className="flex items-center gap-1 px-4 py-2 rounded-full bg-gradient-to-r from-[#4B3D8C] to-[#2EC8C3] text-white text-sm font-medium">
              ...
              <div
                className={`p-8 rounded-2xl backdrop-blur-md border transition-all duration-300 h-full ${
                  plan.popular
                    ...
                    : "bg-[#F3F4F6]/5 border-[#F3F4F6]/10 hover:border-[#2EC8C3]/30"
                }`}
              >
                <div className="mb-8">
                  ...
                  {isYearly && (
                    <div className="text-sm text-[#2EC8C3] mt-1">
                      $
                      {Math.round(
                ...
                <ul className="space-y-4 mb-8">
                  {plan.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center gap-3">
                      <Check className="w-5 h-5 text-[#2EC8C3] flex-shrink-0" />
                ...
                <Button
                  className={`w-full py-3 rounded-2xl font-semibold transition-all duration-300 ${
                    plan.popular
                      ...
                      : "bg-[#F3F4F6]/10 hover:bg-[#2EC8C3]/20 text-[#2EC8C3] border border-[#2EC8C3]/30"
                  }`}
                  asChild
                >
